...
public class ConsAddr {
  // mensagens
  public static final String ADDRESS_REGISTERED_SUCCESS = "Endereço registrado com sucesso";
  public static final String ADDRESS_NOT_FOUND = "Endereço não encontrado";
  public static final String ADDRESS_FOUNDED_SUCCESS = "Endereço encontrado com sucesso";
