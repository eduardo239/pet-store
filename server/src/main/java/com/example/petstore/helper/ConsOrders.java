...
public class ConsOrders {
  // mensagens
  public static final String ORDER_REGISTERED_SUCCESS = "Pedido registrado com sucesso";
  public static final String ORDER_NOT_FOUND = "Pedido não encontrado";
  public static final String ORDER_FOUNDED_SUCCESS = "Pedido encontrado com sucesso";
