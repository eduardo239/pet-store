...
public class ConsPets {
  // mensagens
  public static final String PET_REGISTERED_SUCCESS = "Pet registrado com sucesso";
  ...
  public static final String PETS_REMOVED_SUCCESS = "Pets removidos com sucesso";
}
